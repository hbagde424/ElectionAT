// AlertPartyActivitiesDelete.jsx
        ...
        <Dialog open={open} onClose={handleClose} maxWidth="sm" fullWidth>
            <DialogTitle>
                <Stack direction="row" alignItems="center" spacing={1}>
                    ...
                    <Typography variant="h6">Delete Party Activity</Typography>
                </Stack>
            </DialogTitle>
            <DialogContent>
                <Stack spacing={2}>
                    <Typography>
                        Are you sure you want to delete this party activity? This action cannot be undone.
                    </Typography>
                    <Stack direction="row" spacing={1}>
                        <Chip label="Warning" color="error" size="small" />
                        <Typography variant="body2" color="text.secondary">
                            All associated data including attendance records and media coverage information will be permanently removed.
                        </Typography>
                    </Stack>
                </Stack>
            </DialogContent>
