...
export default function ElectionTypeView({ data }) {
    if (!data) return null;
    ...
    return (
        <Box sx={{ p: 3, bgcolor: 'background.paper', borderRadius: 1 }}>
            <Stack direction="row" alignItems="center" spacing={2} mb={2}>
                <Typography variant="h6">{data.election_name || 'Untitled Election Type'}</Typography>
            </Stack>
            ...
            <Grid container spacing={3}>
                ...
                <Grid item xs={12} md={6} lg={6} xl={6} sm={12}>
                    <Grid container spacing={2}>
                        ...
                        <Grid item xs={12} sm={6} md={4} lg={4} xl={4}>
                            <Typography variant="subtitle2" color="text.secondary" gutterBottom>Election Type ID</Typography>
