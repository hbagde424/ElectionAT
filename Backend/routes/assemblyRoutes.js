 ...
 */
router.get('/', authController.protect, authController.authorize, assemblyController.getAllAssemblies);
 ...
 */
router.get('/vs_code/:vs_code', authController.protect, assemblyController.getAssemblyByVSCode);
