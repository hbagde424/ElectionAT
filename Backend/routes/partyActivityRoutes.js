 ...
 *             type: string
 *             format: uri
  # description: Activity description (HTML allowed) (duplicate removed)
 *         created_by:
 *           type: string
 ...
 *           type: string
 *           maxLength: 1000
 *           description: Activity description (HTML allowed)
 *           example: "<p>Some description about the activity.</p>"
 *         activity_date:
 *           type: string
 *           format: date-time
 *         end_date:
