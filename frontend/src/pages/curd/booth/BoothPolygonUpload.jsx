...
export default function BoothPolygonUpload({ open, onClose, onSuccess }) {
    ...
    const handleUpload = async () => {
        ...
        try {
            ...
            const response = await fetch(`${import.meta.env.VITE_APP_API_URL}/booths/upload-polygon`, {
                method: 'POST',
                headers: {
    ...
    return (
        <Dialog open={open} onClose={handleClose} maxWidth="sm" fullWidth>
            <DialogTitle>Upload Booth Polygons</DialogTitle>
            <DialogContent>
                <Box sx={{ mt: 2 }}>
                    <Typography variant="body2" sx={{ mb: 2 }}>
                        Upload a GeoJSON file containing booth polygons. The file should have booth_number or name properties to match existing booths.
                    </Typography>
