...
export default function BlockPolygonUpload({ open, onClose, onSuccess }) {
    ...
    const handleUpload = async () => {
        ...
        try {
            ...
            const response = await fetch(
                `${import.meta.env.VITE_APP_API_URL}/blocks/upload-polygon`,
                {
                    method: 'POST',
                    headers,
            ...
            setSuccess(result.message || `✓ Block polygon "${geoJsonData.name || 'File'}" uploaded successfully!`);
    ...
    return (
        <Dialog open={open} onClose={handleClose} maxWidth="sm" fullWidth>
            <DialogTitle>Upload Block Polygon (GeoJSON)</DialogTitle>
            <DialogContent>
